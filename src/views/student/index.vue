  ...
  <div class="app-container">
    <div class="filter-container">
      <div class="searchConditions">
        ...
        <el-select v-model="listQuery.carType" placeholder="请选择" style="width: 300px;margin-right: 10px;"
          @change='getCarType'>
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" style="width: 100%;">
      ...
      <el-table-column label="考试次数" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.examNum }}</span>
        </template>
      </el-table-column>
      <!--<el-table-column label="考试流水号" align="center">-->
      <!--<template slot-scope="scope">-->
      <!--<span>{{ scope.row.serialNum }}</span>-->
      <!--</template>-->
      <!--</el-table-column>-->
      <el-table-column label="考车信息" align="center" min-width="120">
        <template slot-scope="scope">
      ...
      <el-table-column label="考试开始时间" align="center" width="200">
        <template slot-scope="scope">
          <span>{{ scope.row.startTime }}</span>
        </template>
      </el-table-column>
      <el-table-column label="考试结束时间" align="center" width="200">
        <template slot-scope="scope">
      ...
      <el-table-column label="查看" align="center" width="200px">
        <template slot-scope="{row}">
          <el-button size="mini" v-if="row.examFlag == 1" :type="row.btnstyle" @click="handleCheat(row)">
            异常行为
          </el-button>
        </template>
      </el-table-column>
