<template>
  <div class="app-container">
    ...
    <div id="main">
      <div class="stage" id='videoContainer' v-loading="loading" element-loading-text="视频正在生成，预计15秒，请稍后..." element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)">
      ...
      <div class="middle">
        <div class="back">
          ...
          <div style="min-width:60px;" class="color1 font2">{{animatedSpeed}}</div>
          <div class="color3">档&nbsp位：</div>
          <div style="min-width:60px;" class="color1 font2">{{gear}}</div>
          <div class="color3">发动机转速：</div>
          <div style="min-width:60px;" class="color1 font2">{{rp}}</div>
        </div>
        <div class="back">
