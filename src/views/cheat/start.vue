<template>
  <div class="app-container" :style="'background:repeat '+ditu+';background-size:cover'">
    ...
    <div id="message" style="display: flex;justify-content: center; margin-bottom: 1em;">
      ...
      <el-button class="filter-item" style="margin-left:10px;width:150px;" type="danger" @click="recordVideo(0)" :loading="btnLoading[0]">
        主动协助
      </el-button>
      <el-button class="filter-item" style="width:150px;" type="danger" @click="recordVideo(2)" :loading="btnLoading[2]">
        手势
      </el-button>
      <el-button class="filter-item" style="width:150px;" type="danger" @click="recordVideo(1)" :loading="btnLoading[1]">
        讲话
      </el-button>
      <el-button class="filter-item" style="width:150px;" type="danger" @click="recordVideo(3)" :loading="btnLoading[3]">
        异常音
      </el-button>
      ...
      <div class="info font1"
        ...
        <div class="border" style="padding: 1em;">
          ...
          <div class="row">
            ...
            <span class="color3">安全员号：</span><span class="color1">张三</span>
          </div>
          <div class="row">
    ...
    methods:
      {
        ...
        play() {
          ...
          for (let i=1;i<10;i++){
            ...
            // console.log('timestamp-'+Number(this.timestamp)+i)
        ...
        refreshData(data) {  //刷新数据
          ...
          // let score = this.score - data.deductionValue
        ...
        changeCar(number){
          // console.log(number+'号车')
          if(number === 7){
            this.wsip = 'ws://192.168.51.7:9088'
