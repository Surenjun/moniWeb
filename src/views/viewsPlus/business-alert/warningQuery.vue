  ...
  <div class="app-container">
    <div class="filter-container">
      <div class="searchConditions">
        ...
        <el-input v-model="listQuery.idCard" placeholder="标题" style="width: 300px;" class="filter-item"
                  @keyup.enter.native="handleFilter" clearable />
        <el-input v-model="listQuery.name" placeholder="类型" style="width: 300px;" class="filter-item"
                  @keyup.enter.native="handleFilter" clearable />
