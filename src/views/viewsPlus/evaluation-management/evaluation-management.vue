<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button style="width: 100px;margin-left: 55%" class="filter-item">导入</el-button>
      <el-button style="width: 100px;" class="filter-item">导出</el-button>
    </div>
    <el-table :key="tableKey" v-loading="false" :data="list" style="width: 100%;">
      ...
      <el-table-column label="评测路线" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row['评测路线'] }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="场景分类" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row['场景分类'] }}</span>
        </template>
      </el-table-column>
